...
- [Quick Start (AWS CloudShell)](#quick-start-aws-cloudshell)
...
# 3. Configure your instance ID
nano find_duplicate_users_parallel.sh
# Update: INSTANCE_ID="your-instance-id"
...
**For detailed CloudShell instructions, see [QUICKSTART_CLOUDSHELL.md](QUICKSTART_CLOUDSHELL.md)**

**Processing 44,000 users?** The parallel script will complete in ~90 minutes with automatic keep-alive.
...
For faster processing of large user bases, use the parallel version:
...
- Sequential: ~1 second per user
- Parallel (2 workers): ~0.5 seconds per user
- **Example**: 500 users = 10 minutes sequential vs 5 minutes parallel
